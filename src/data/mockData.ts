...
const LAYER_GROUPS: LayerGroup[] = [
  ...
  },
  {
    ...
    label: "Cadastral",
    layers: [
      { id: "parcels", label: "Parcel Boundaries", visible: true, opacity: 1 },
...
export const THEMATIC_LAYER_CONFIGS: LayerConfig[] = [
  { id: "crops", label: "Crops Grown", visible: false },
  { id: "buildings", label: "Buildings", visible: false },
  { id: "trees", label: "Trees", visible: false },
  { id: "roads", label: "Roads", visible: false },
  { id: "waterBodies", label: "Water Bodies", visible: false },
  { id: "forest", label: "Forest", visible: false },
  { id: "dgps", label: "DGPS / GNSS Points", visible: false },
  { id: "variance", label: "Variance Bands", visible: false },
  { id: "cadastralDimensions", label: "Chain & Dimensions", visible: false },
];
